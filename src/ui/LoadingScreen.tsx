...
export function LoadingScreen({
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#07070b] px-4 py-6 text-[#f5ecdf] sm:px-6 lg:px-8">
      ...
      <div className="relative w-full max-w-3xl overflow-hidden rounded-[28px] border border-white/10 bg-[rgba(22,18,24,0.88)] px-6 py-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.42)] backdrop-blur-xl sm:px-8 sm:py-10">
        ...
        <div className="relative z-10 mx-auto mb-8 aspect-square w-[min(78vw,320px)]">
        ...
        <h1 className="relative z-10 mt-4 font-display text-[clamp(3.2rem,9vw,5.75rem)] leading-[0.92] tracking-[0.02em] text-[#fff1cf]">
          Bound Souls
        </h1>
        <p className="relative z-10 mx-auto mt-4 max-w-[30rem] text-[0.98rem] leading-[1.72] text-[rgba(233,223,211,0.72)]">
